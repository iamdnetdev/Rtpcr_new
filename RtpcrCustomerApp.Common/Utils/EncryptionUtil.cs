namespace RtpcrCustomerApp.Common.Utils
{
    ...
    {
        private const string EncryptionKey = "RtPcRCoViD19VAcciNaTioN#$%^&";
        private const string Salt = "vAcCiN@Ti0nC0V!DRTpCr#@!";
        ...
        public static string EncryptSecure(string plainText)
        {
        ...
        public static string Encrypt(string plainText)
        {
            using (var aes = GetAes())
            {
                ...
                var encrypted = aes.CreateEncryptor().TransformFinalBlock(bytes, 0, bytes.Length);
        ...
        public static string Decrypt(string cipherText)
        {
            using (var aes = GetAes())
            {
                ...
                var decrypted = aes.CreateDecryptor().TransformFinalBlock(bytes, 0, bytes.Length);
