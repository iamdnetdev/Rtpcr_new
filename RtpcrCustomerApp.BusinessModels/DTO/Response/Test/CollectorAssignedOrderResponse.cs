namespace RtpcrCustomerApp.BusinessModels.DTO.Response.Test
{
    ...
    public class CollectorAssignedOrderResponse : IResponse
    {
        ...
        public List<CollectorAssignedOrderDetails> AssignedOrderDetails { get; set; }
    }

    public class CollectorAssignedOrderDetails
    {
